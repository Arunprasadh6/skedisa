    ...
    return (function(t) {
                ...
                i = (function() {
                    ...
                    return (
                        (t.parse = function(e, n) {
                            ...
                            return (!!s.isValid() &&
                                (null == l && null == (l = n.allDayDefault) && (l = o.opt("allDayDefault")), !0 === l ? (s.stripTime(), a && a.stripTime()) : !1 === l && (s.hasTime() || s.time(0), a && !a.hasTime() && a.time(0)), !a || (a.isValid() && a.isAfter(s)) || (a = null), !a && u && (a = o.getDefaultEventEnd(!s.hasTime(), s)),
                                    new t(s, a, o))
                            );
                        }),
                    ...
                    return (
                        ...
                        (t.prototype.buildNewDateProfile = function(t, e) {
                            ...
                            return (
                                ...
                                o && ((n = e.applyTimezone(n)), r && (r = e.applyTimezone(r))), !r && e.opt("forceEventDuration") && (r = e.getDefaultEventEnd(t.isAllDay(), n)),
                                new i.default(n, r, e)
                            );
                        }),
        ...
        function(t, e, n) {
                    ...
                    return (
                        ...
                        (e.prototype.computeTitle = function(t) {
                            ...
                            return (
                                ...
                                this.formatRange({ start: this.calendar.msToMoment(e.startMs, t.isRangeAllDay), end: this.calendar.msToMoment(e.endMs, t.isRangeAllDay) },
                                    t.isRangeAllDay,
            ...
            p.watch(
                ...
                p.watch(
                    "displayingBusinessHours", ["displayingDates", "businessHourGenerator"],
                    function(t) {
                ...
                p.watch(
                    "displayingEvents", ["displayingDates", "hasEvents"],
                    function() {
        ...
        function(t, e, n) {
            ...
            function u(t) {
                for (var e, n = [], r = /\[([^\]]*)\]|\(([^\)]*)\)|(LTS|LT|(\w)\4*o?)|([^\w\[\(]+)/g;
                    (e = r.exec(t));)
                    ...
                    return (
                        ...
                        (t.prototype.buildCurrentRangeInfo = function(t, e) {
                            ...
                            return (
                                ...
                                ((o = this.getFallbackDuration()), (s = i.computeGreatestUnit(o)), (a = this.buildRangeFromDuration(t, e, o, s))), { duration: o, unit: s, unzonedRange: a }
                            );
                        }),
                ...
                s = (function(t) {
                    ...
                    return (
                        ...
                        (e.prototype.updateDayTable = function() {
                            for (
                                var t, e, n, r = this, i = r.view, o = i.calendar, s = o.msToUtcMoment(r.dateProfile.renderUnzonedRange.startMs, !0), a = o.msToUtcMoment(r.dateProfile.renderUnzonedRange.endMs, !0), l = -1, u = [], d = []; s.isBefore(a);
                    ...
                    return (
                        ...
                        (t.prototype.parseFootprints = function(t) {
                            ...
                            return (
                                ...
                                t.end && ((n = this._calendar.moment(t.end)), n.isValid() || (n = null)), [new s.default(new o.default(e, n), (e && !e.hasTime()) || (n && !n.hasTime()))]
                            );
                        }),
                    ...
                    return (
                        ...
                        (t.prototype.querySources = function(t) {
                            ...
                            for (e = 0; e < o.length; e++)
                                if ((n = o[e]) === t) return [n];
                            return (n = this.getSourceById(l.default.normalizeId(t))) ? [n] :
                    ...
                    return (
                        ...
                        (t.prototype.position = function() {
                            ...
                            p.is(window) || p.is(document) ? ((p = c), (t = 0), (e = 0)) : ((n = p.offset()), (t = n.top), (e = n.left)),
                                (t += c.scrollTop()),
                                (e += c.scrollLeft()), !1 !== a.viewportConstrain &&
                    ...
                    return (
                        ...
                        (e.prototype.buildGotoAnchorHtml = function(t, e, n) {
                            ...
                            return (
                                ...
                                (e = e ? " " + a.attrsToStr(e) : ""),
                                (n = n || ""), !s && this.opt("navLinks") ? "<a" + e + ' data-goto="' + a.htmlEscape(JSON.stringify(u)) + '">' + n + "</a>" : "<span" + e + ">" + n + "</span>"
                            );
                        }),
                    ...
                    return (
                        ...
                        (t.prototype.initialRender = function() {
                            ...
                            e.addClass("fc"),
                                ...
                                this.optionsManager.watch(
                                    "settingTheme", ["?theme", "?themeSystem"],
                                    function(n) {
                                ...
                                this.optionsManager.watch(
                                    "settingBusinessHourGenerator", ["?businessHours"],
                                    function(e) {
                        ...
                        (t.prototype.renderView = function(t) {
                            ...
                            this.freezeContentHeight(),
                                n && t && n.type !== t && this.clearView(), !this.view &&
                                t &&
        ...
        function(t, e, n) {
            function r(t) {
                ...
                return (
                    ...
                    (i = Boolean(i)), { eventProps: e, startTime: n, duration: r, stick: i }
                );
            }
            Object.defineProperty(e, "__esModule", { value: !0 });
            var i = n(2),
            ...
            var o = n(2),
                ...
                u = (function(t) {
                    ...
                    return (
                        ...
                        (e.prototype.unrenderFgSegs = function() {
                            for (var t, e = this.rowStructs || [];
                                (t = e.pop());) t.tbodyEl.remove();
