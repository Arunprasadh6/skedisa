...
(function(exports) {
            ...
            .done(function(response) {
                ...
                if (response.length > 0) {
                    ...
                    response.forEach(function(availableHour) {
                        ...
                        var dte = moment(selectedDate + " " + availableHour);
                        var date2 = selectedDate + " " + availableHour;
                        ...
                        var day0 = yr + "-" + month + "-" + day;
                        //var split_time=availableHour.substr(0,2);
                        //   console.log(date2 +" "+tme);
                    ...
                    $('#available-hours').css('column-count', '3');
                    ...
                    $('#available-hours').css('column-count', 'unset');
    ...
    exports.registerAppointment = function() {
        ...
        var url = GlobalVariables.baseUrl + '/index.php/appointments/ajax_register_duplicate_appointment';
