    ...
    exports.initialize = function (defaultEventHandlers) {
        ...
        GlobalVariables.settings.system.forEach(function (setting) {
            ...
            if (setting.name === 'company_working_plan') {
              ...
              if (setting.name === 'availability') {
                 $('#availablity').val(setting.value);
            }
            if (setting.name === 'Company_count') {
                $('#comp_num').val(setting.value);
           }
           if (setting.name === 'refund_hour') {
            $('#refund_hour').val(setting.value);
        }
        if (setting.name === 'refund_percentage') {
            $('#refund_per').val(setting.value);
        }
        ...
        $('#last-name').val(GlobalVariables.settings.user.MRN);
        $('#email').val(GlobalVariables.settings.user.email);
        $('#mobile-number').val(GlobalVariables.settings.user.mobile_number);
        $('#phone-number-cnt').val(GlobalVariables.settings.user.phone_number);
