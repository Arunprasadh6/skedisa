...
(function () {
    ...
    AdminsHelper.prototype.bindEventHandlers = function () {
        ...
        $('#admins').on('click', '#save-admin', function () {
            ...
            if( $('#admin-email').val().length > 0){

            
            var reg = /^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/;
            
            if (reg.test($('#admin-email').val()) == false) 
            {
    ...
    AdminsHelper.prototype.getFilterHtml = function (admin) {
        var name = admin.first_name + ' ' + admin.MRN;
        ...
        info = info ? info + ', ' + admin.phone_number : admin.phone_number;
