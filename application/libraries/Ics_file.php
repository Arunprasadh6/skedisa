...
class Ics_file {
    ...
    public function get_stream($appointment, $service, $provider, $customer)
    {
        ...
        $description = [
            ...
            lang('provider'),
            '',
            lang('name') . ': ' . $provider['first_name'] . ' ' . $provider['MRN'],
            ...
            lang('customer'),
            '',
            lang('name') . ': ' . $customer['first_name'] . ' ' . $customer['MRN'],
        ...
        $attendee->setName($customer['first_name'] . ' ' . $customer['MRN']);
        ...
        $attendee->setName($provider['first_name'] . ' ' . $provider['MRN']);
        $attendee->setCalendarUserType('INDIVIDUAL')
            ->setRole('REQ-PARTICIPANT')
        ...
        $organizer
            ...
            ->setName($provider['first_name'] . ' ' . $provider['MRN']);
