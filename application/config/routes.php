...
//$route['default_controller'] = 'customer_auth';
$route['404_override'] = 'errors/error404';

//$route['login']='customers/login';
$route['register']='customers/auth_register';
//$route['check_organization']='check_organization';
//$route['check_email']='check_email';
