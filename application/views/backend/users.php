...
<div class="container-fluid backend-page" id="users-page">
    ...
    <ul class="nav nav-pills">
        ...
        <?php   $oid=$this->session->userdata('Organization');
        if($oid==1 || $oid==8) {
        ?>
        <li class="nav-item">
            <a class="nav-link" href="#admins" id="orgn" data-toggle="tab">
                <?= lang('admins') ?>
            </a>
        </li>
        <?php } ?>
                            ...
                            <div class="row">
                                <div class="provider-details col-12 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="provider-phone-number" class="form-control required" maxlength="10">
                                        <span id="pro_mno_error" style="display:none;color:red">Number is Already Available Please Change Number</span>
                                    </div>
                                    ...
                                    <div class="form-group" style="display:none;">
                                        ...
                                        <input id="provider-mobile-number" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" class="form-control" maxlength="128">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="provider-city" onkeyup="this.value=this.value.replace(/[^a-z A-Z]/g,'')" class="form-control" maxlength="256">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="provider-state" onkeyup="this.value=this.value.replace(/[^a-z A-Z]/g,'')" class="form-control" maxlength="256">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="provider-zip-code" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" class="form-control" maxlength="6">
                                    </div>
                                ...
                                <div class="provider-settings col-12 col-md-6">
                                    ...
                                    <h4 id='sid'><?= lang('services') ?>  <span class="text-danger">*</span></h4>
                ...
                <div class="record-details column col-12 col-md-7">
                    ...
                    <div class="row">
                        <div class="secretary-details col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input id="secretary-first-name" class="form-control required" maxlength="256">
                                 <span style="display:none" id="secretary-org"><?php  echo $this->session->userdata('Organization'); ?></span>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="secretary-phone-number" class="form-control required" maxlength="10">
                                <span id="sec_mno_error" style="display:none;color:red">Number is Already Available Please Change Number</span>
                            </div>
                             ...
                             <div class="form-group" style="display:none;">
                                ...
                                <input id="secretary-mobile-number" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" class="form-control" maxlength="128">
                            </div> 
                            ...
                            <div class="form-group">
                                ...
                                <input id="secretary-city" onkeyup="this.value=this.value.replace(/[^a-z A-Z]/g,'')" class="form-control" maxlength="256">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="secretary-state" onkeyup="this.value=this.value.replace(/[^a-z A-Z]/g,'')" class="form-control" maxlength="128">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="secretary-zip-code" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" class="form-control" maxlength="6">
                            </div>
                        ...
                        <div class="secretary-settings col-12 col-md-6">
                            ...
                            <h4 id='prid'><?= lang('providers') ?>  <span class="text-danger">*</span></h4>
                            <input type="hidden" id="secretary-org1"  value=""/>
                    ...
                    <div class="row">
                        <div class="admin-details col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input id="admin-phone-number" class="form-control " maxlength="10">
                                <span id="admin_mno_error" style="display:none;color:red">Number is Already Available Please Change Number</span>
                            </div>
                            ...
                            <div class="form-group" style="display:none;">
                                ...
                                <input id="admin-mobile-number" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" class="form-control" maxlength="128">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="admin-city" class="form-control" onkeyup="this.value=this.value.replace(/[^a-z A-Z]/g,'')" maxlength="256">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="admin-state" class="form-control" onkeyup="this.value=this.value.replace(/[^a-z A-Z]/g,'')" maxlength="128">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="admin-zip-code" class="form-control" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" maxlength="6">
                            </div>
                        ...
                        <div class="admin-settings col-12 col-md-6">
                            ...
                            <div  class="form-group">
                                  <label for="username">Select Organization<span class="text-danger">*</span></label>
...
<style>
    /*.working-plan  tbody tr:nth-child(1) {*/
    /*    display:none;*/
    /*}*/
    /*.breaks  tbody tr:nth-child(1),.breaks  tbody tr:nth-child(2) {*/
    /*    display:none;*/
    /*}*/
</style>
