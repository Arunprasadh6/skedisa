        ...
        <div class="tab-pane active" id="services">
            <div class="row">
                ...
                <div class="record-details column col-12 col-md-5">
                    ...
                    <h3><?= lang('details') ?></h3>
                    <span id="service-org" style="display:none"><? echo $this->session->userdata('Organization'); ?></span>
                    ...
                    <div class="form-group">
                        ...
                        <input id="service-name" onkeyup="this.value=this.value.replace(/[^a-z A-Z]/g,'')"  class="form-control required" maxlength="128">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input id="service-duration" class="form-control required" type="text" maxlength="3" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input id="service-price" maxlength="7" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" class="form-control required">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input id="service-currency" onkeyup="this.value=this.value.replace(/[^a-z A-Z]/g,'')" class="form-control" maxlength="32">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input id="service-attendants-number" class="form-control required" type="text" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" maxlength="2">
                    </div>
