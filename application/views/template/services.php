                        ...
                        <div class="table-responsive">
                            <table id="data-table" class="table table-straped datatable dt-responsive nowrap" data-bs-page-length="5"
                                ...
                                <tbody class="table-light">
                                    ...
                                    foreach($available_services as $row){ ?>
                                    <tr>
                                ...
                                <div class="form-message alert" style="display:none;"></div>
                                    <div class="col-md-4">
                                        <div class="form-group">                                            
                                            ...
                                            <input type="text"   onkeyup="this.value=this.value.replace(/[^a-z A-Z]/g,'')" id="service-name" name="service_name" class="form-control "
                                                placeholder="Name" />
                                                <span id="service-org"
...
// $.ajax(method,url,data,success,fail)
...
function edit_service(id,name,dur,price,cur,type,attend,dept){
    setTimeout(() => {
        var validator = $("#service-frm").validate();
    validator.resetForm();
    }, 500);
