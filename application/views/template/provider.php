...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="col-lg-12">
                <div class="card" style="background: #f1f5f7;box-shadow: 2px 0px 4px 4px rgb(0 0 0 / 8%);">
                    <div class="card-body table-light">
                        <div class="row">
                            ...
                            <button style="float: right;" type="button" class="btn btn-primary waves-effect waves-light"
    ...
    $.post(url, data)
        .done(function(response) {
          ...
          //  $('#phone-country').val(rows[0].mobile_number);
            ...
            document.getElementById('pro-img').src = "<?php echo base_url('assets/img/upload_img/') ?>" + rows[0].Images;
            } else {
